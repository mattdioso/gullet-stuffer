        ...
        return (
          <div className="w-full h-full overflow-y-hidden">
            ...
            {/* <div className={this.state.ended ? "visible block h-screen w-full" : "invisible max-h-0 opacity-0"}> */}
                ...
                <div className="visible h-fit flex pt-96 md:pt-0 m-auto md:invisible md:h-0 md:opacity-0">
                ...
                <div className="h-0 md:w-full flex md:pt-28 md:visible invisible md:h-fit opacity-0 md:opacity-100 md:z-50">
            ...
            {/* </div> */}
            <footer className='h-2 bg-black'></footer>
          </div>
        );
    }
}
