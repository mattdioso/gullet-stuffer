                ...
                <div className="md:flex w-full">
                    <div className='md:w-1/2 md:h-1/2'>
                        <div className='md:pl-28 text-center md:text-left '>
                            ...
                            <p className='text-[4.5rem] md:text-[8rem] text-gs_red leading-[35px] md:leading-[60px]'>Stuffer</p>
                        </div>
                    ...
                    <div className='md:w-1/2 my-auto'>
                        <div className='mt-4 md:mt-0 md:pl-8 px-4 md:px-0 md:pr-8 pt-0 w-full text-center md:text-left'>
                            <div className='w-full 2xl:w-4/5'>
                                ...
                                <br />
                                <p className='text-xs md:text-base 2xl:text-xl font-heavitas text-gs_purple'>Brought back by popular demand and here to stay, this infamous annual event serves as a fundraiser, community gathering, and showcase of local eating talent.</p>
                                <br />
                        ...
                        <div className="mt-4 md:mt-0 md:pl-8 px-4 md:px-0 md:pr-8 pt-0 w-full 2xl:w-4/5 text-center">
                            <br />
                            <p className='text-sm md:text-base 2xl:text-xl font-heavitas text-gs_purple'>Gullet Stuffer is a 501c3 non-profit organization. EIN: 99-2709550</p>
                        </div>
                    </div>
                </div>
