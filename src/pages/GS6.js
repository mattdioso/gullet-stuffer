    ...
    render() {
        return (
            <main class="w-full pt-28 md:pt-40 bg-black">
                <section class="flex w-11/12 bg-neutral-800 mx-auto rounded-xl perspective">
                    <div class="w-1/2 ">
                    ...
                    <div class="w-1/2 pt-10">
                        <p className="text-orange-400 text-center text-6xl 2xl:text-8xl">Gullet Stuffer 6</p>
                        <p className="text-white text-center text-xl 2xl:text-3xl my-4">Join us for the sixth annual Gullet Stuffer event!</p>
                        <p className="text-orange-400 text-xl 2xl:text-3xl ml-6 mt-8 2xl:mt-24">Date and Time</p>
