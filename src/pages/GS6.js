                    ...
                    <div class="md:w-1/2 md:pt-10">
                        ...
                        <div className="w-full flex mt-6 pb-6 md:pb-0 md:mt-4">
                            <div className="w-1/2 text-center">
                                <p className="text-orange-400 text-2xl 2xl:text-4xl ml-6 mt-4 md:mt-8 2xl:mt-24">Date and Time</p>
                                <p className="text-white text-xl 2xl:text-2xl ml-6 mt-2">Saturday, July 13th 2024</p>
                                <p className="text-white text-xl 2xl:text-2xl ml-6 mt">6pm to 10pm</p>
                            </div>
                            <div className="w-1/2 text-center">
                                <p className="text-orange-400 text-2xl 2xl:text-4xl mt-4 md:mt-8 2xl:mt-24">Location</p>
