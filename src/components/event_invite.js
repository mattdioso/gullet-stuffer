const EventInvite = () => {
    return (
        <div class="w-8/12 bg-neutral-800 mx-auto rounded-xl perspective mt-6">
            <div className="md:flex mt-6 sm:mt-0">
                ...
                <div class="w-full md:pt-6 md:pl-1">
                    ...
                    <div className="flex">
                        <div className="w-1/2 mt-6 pb-6 md:pb-0 md:mt-2">
                        ...
                        <div className="w-1/2 flex justify-center my-auto">
                            <img className="h-56 w-56" src="https://storage.googleapis.com/gulllet-stuffer.appspot.com/logos/GS1_logo.png" alt="logo" />
                        </div>
                    </div>
                </div>
            </div>
