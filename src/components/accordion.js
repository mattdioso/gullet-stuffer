            ...
            <div className={`flex flex-row justify-between cursor-pointer border-y border-white hover:bg-gray-400 p-2 ${isActive ? "bg-gray-800" : "bg-black"}`} onClick={() => setIsActive(!isActive)}>
                <div className='flex flex-col-reverse md:grid md:grid-cols-8 w-1/2'>
                    <div className="md:col-start-1 md:col-span-5 my-auto">
                        <p className='text-center text-white text-xl md:text-2xl font-abcgintonord-med mt-2 md:mt-4 md:my-auto'>{pros[0].firstName} {pros[0].lastName}</p>
                        <p className='text-center text-white text-base md:text-xl font-abcgintonord-med mb-2 md:mb-4 md:my-auto'>{pros[0].result} {year.food}</p>
                    </div>
                ...
                <div className='md:grid md:grid-cols-8 w-1/2'>
                    ...
                    <div className="md:col-start-4 md:col-span-5 my-auto">
                        <p className='text-center text-white text-xl md:text-2xl font-abcgintonord-med mt-2 md:mt-4 md:my-auto'>{amateurs[0].firstName} {amateurs[0].lastName}</p>
                        <p className='text-center text-white text-base md:text-xl font-abcgintonord-med mb-2 md:mb-4 md:my-auto'>{amateurs[0].result} {year.food}</p>
                    </div>
                </div>
                        ...
                        <tbody>
                            {
                                pros.slice(1).map((pro, i) => (
                                    <tr>
                                        ...
                                        <td className='text-[12px] text-center font-abcgintonord-med  md:text-2xl text-white'>{pro.firstName} {pro.lastName}</td>
                                        <td className='text-[14px] text-center font-abcgintonord-med  md:text-2xl text-white drop-shadow-2xl pr-2'>{pro.result}</td>
                                    </tr>
                                ))
                            }
                        </tbody>
                        ...
                        <tbody>
                            {
                                amateurs.slice(1).map((amateur, i) => (
                                    <tr>
                                        ...
                                        <td className='text-[12px] text-center font-abcgintonord-med  md:text-2xl text-white'>{amateur.firstName} {amateur.lastName}</td>
                                        <td className='text-[14px] text-center font-abcgintonord-med  md:text-2xl text-white drop-shadow-2xl pr-1'>{amateur.result}</td>
                                    </tr>
                                ))
                            }
                        </tbody>
