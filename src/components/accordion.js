                        ...
                        <tbody>
                            {
                                pros.slice(1).map((pro, i) => (
                                    <tr>
                                        ...
                                        <td className='text-[14px] text-center font-heavitas  md:text-2xl text-white drop-shadow-2xl pr-2'>{pro.result}</td>
                                    </tr>
                                ))
                            }
                        </tbody>
                        ...
                        <tbody>
                            {
                                amateurs.slice(1).map((amateur, i) => (
                                    <tr>
                                        ...
                                        <td className='text-[14px] text-center font-heavitas  md:text-2xl text-white drop-shadow-2xl pr-1'>{amateur.result}</td>
                                    </tr>
                                ))
                            }
                        </tbody>
